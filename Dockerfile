...
# we don't really have any sensible alternatives to just grabbing the binary tarball for
# the prometheus metric exporter, but at least we can assert its sha256
